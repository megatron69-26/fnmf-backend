    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                ...
                .info(new Info()
                        ...
                        .description("Tài liệu đặc tả toàn bộ 21 REST API cho Hệ thống Backend FNMF (Bao gồm Xác thực Auth, Dữ liệu Thị trường Alpha Vantage, Phân tích Tin tức Gemini AI, Danh mục Theo dõi Watchlist, Giao dịch Giả lập Paper Trading, Dự báo Thị trường AI và Module Mobile Sync cho Android Room Database).")
                        .version("1.2.0")
                        .contact(new Contact()
